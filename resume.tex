...
\item{\cventry{Feb 2025 -- Present}{Senior Software Engineer, Full Time}{QuintoAndar}{São Paulo, Brazil (Remote)}{}{\vspace{3pt}At QuintoAndar, I'm currently building AI-powered multi-agentic solutions. My work aims to enhance and scale our inside sales team's operation capacity, driving efficiency and improving customer engagement.\\
{\color{gray} Tech Stack:} AWS, Python, LLMs, AI Agents.}}

\vspace{6pt}

\item{\cventry{Oct 2020 -- Jan 2025}{Senior Software Engineer, Full Time}{VTEX}{João Pessoa, Brazil}{}{\vspace{3pt}Part of the Payments team, which is mainly responsible for maintaining the PCI-compliant Payment Gateway, and other payment-related products. I already contributed executing stack modernization related tasks, and efficiency improvements, reducing costs and improving the system reliability and resiliency.\\
{\color{gray} Tech Stack:} AWS, .NET, C\#, SQL, Redis, ActiveMQ.}}

\vspace{6pt}

\item{\cventry{Apr 2020 -- Sep 2020}{Software Engineer, Full Time}{Scontain U.G.}{Dresden, Germany}{}{\vspace{3pt}At Scontain I mainly contributed to the SCONE runtime, and also contributed to the development of a modified SGX Linux Driver, enabling selective enclave eviction support. Also led the development of a Kubernetes device driver, to make SGX available for being used by Kubernetes pods.\\
...
\item \textbf{Programming Languages:} Python, Java, JavaScript, R, C/C++, C\#.

\vspace{6pt}

\item \textbf{Cloud-related and Orchestration:} Docker, OpenStack, Kubernetes.
